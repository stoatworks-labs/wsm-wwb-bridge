...
[![Watch it running — 46 seconds](docs/video-thumb.png)](https://www.youtube.com/watch?v=ZoBX4_d7r9M)
...
**[v1.1.0](https://github.com/stoatworks-labs/wsm-wwb-bridge/releases/tag/v1.1.0)** — prebuilt for macOS, Windows and Linux. Pick your platform:
...
| Build | Download | Size |
| --- | --- | --- |
| Apple Silicon · .dmg disk image | [`wsm-wwb-bridge-1.1.0-macos-aarch64.dmg`](https://github.com/stoatworks-labs/wsm-wwb-bridge/releases/download/v1.1.0/wsm-wwb-bridge-1.1.0-macos-aarch64.dmg) | 11 MB |
| Intel · .dmg disk image | [`wsm-wwb-bridge-1.1.0-macos-x86_64.dmg`](https://github.com/stoatworks-labs/wsm-wwb-bridge/releases/download/v1.1.0/wsm-wwb-bridge-1.1.0-macos-x86_64.dmg) | 11 MB |
| Apple Silicon · .pkg installer | [`wsm-wwb-bridge-1.1.0-macos-aarch64.pkg`](https://github.com/stoatworks-labs/wsm-wwb-bridge/releases/download/v1.1.0/wsm-wwb-bridge-1.1.0-macos-aarch64.pkg) | 11 MB |
| Intel · .pkg installer | [`wsm-wwb-bridge-1.1.0-macos-x86_64.pkg`](https://github.com/stoatworks-labs/wsm-wwb-bridge/releases/download/v1.1.0/wsm-wwb-bridge-1.1.0-macos-x86_64.pkg) | 11 MB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`wsm-wwb-bridge-1.1.0-windows-x86_64-setup.exe`](https://github.com/stoatworks-labs/wsm-wwb-bridge/releases/download/v1.1.0/wsm-wwb-bridge-1.1.0-windows-x86_64-setup.exe) | 12 MB |
| ARM64 · .exe installer | [`wsm-wwb-bridge-1.1.0-windows-aarch64-setup.exe`](https://github.com/stoatworks-labs/wsm-wwb-bridge/releases/download/v1.1.0/wsm-wwb-bridge-1.1.0-windows-aarch64-setup.exe) | 12 MB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .deb package (Debian/Ubuntu) | [`wsm-wwb-bridge_1.1.0_amd64.deb`](https://github.com/stoatworks-labs/wsm-wwb-bridge/releases/download/v1.1.0/wsm-wwb-bridge_1.1.0_amd64.deb) | 26 MB |
| ARM64 · .deb package (Debian/Ubuntu) | [`wsm-wwb-bridge_1.1.0_arm64.deb`](https://github.com/stoatworks-labs/wsm-wwb-bridge/releases/download/v1.1.0/wsm-wwb-bridge_1.1.0_arm64.deb) | 25 MB |
| x64 · .rpm package (Fedora/RHEL) | [`wsm-wwb-bridge-1.1.0-1.x86_64.rpm`](https://github.com/stoatworks-labs/wsm-wwb-bridge/releases/download/v1.1.0/wsm-wwb-bridge-1.1.0-1.x86_64.rpm) | 26 MB |
| ARM64 · .rpm package (Fedora/RHEL) | [`wsm-wwb-bridge-1.1.0-1.aarch64.rpm`](https://github.com/stoatworks-labs/wsm-wwb-bridge/releases/download/v1.1.0/wsm-wwb-bridge-1.1.0-1.aarch64.rpm) | 25 MB |
